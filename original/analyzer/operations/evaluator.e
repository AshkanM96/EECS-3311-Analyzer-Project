...
feature -- Binary Op. Expressions
	...
	visit_equality (e: EQUALITY)
		...
		do
			...
			correct_value: value.is_boolean
			empty_set: set.is_empty
		end
...
invariant
	value_empty_relation_to_set: (value.is_empty or else value.is_boolean or else value.is_integer_64 or else (value ~ "{}")) = set.is_empty
