			...
			if checker.is_int then
				...
				if checker.is_int then
					...
					if (not mod_by_not_positive) then
						...
						if ((not mod_by_not_positive) and then (not division_by_zero)) then
